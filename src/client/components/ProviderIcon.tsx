...
function GoogleMark({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" aria-hidden="true" focusable="false">
      ...
      <path
        fill="#34A853"
        d="M9 18c2.43 0 4.467-.806 5.956-2.181l-2.908-2.258c-.806.54-1.837.859-3.048.859-2.344 0-4.328-1.583-5.036-3.71H.957v2.332A8.997 8.997 0 0 0 9 18Z"
      />
      <path
        fill="#FBBC05"
...
export function ProviderIcon({ provider, size = 16 }: { provider: SocialProvider; size?: 16 | 18 | 20 }) {
  return provider === "google" ? <GoogleMark size={size} /> : <GitHubMark size={size} />;
}
