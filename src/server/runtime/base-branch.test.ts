...
vi.mock("./sandbox.js", () => ({ sandbox: { removeContainer } }));
vi.mock("./browser-session.js", () => ({ browserSessions: { close: closeBrowser } }));
vi.mock("./sandbox-processes.js", () => ({ processManager: { stopAll } }));
